...
Dans un second temps, le projet imposait de trouver un moyen de récupérer 

![schema-projet](/assets/images/projects/mutualizer.png#center)

Avec le peu de temps qui nous était impartis, nous nous sommes orienté vers la conception d'une application lourde C#/WPF très simpliste intégrant deux librairies tierces :
 1. [DataMatrix.Net](http://datamatrixnet.sourceforge.net/) : qui permet la lecture d'un DataMatrix dans une image
 2. L'OCR [Tesseract](https://opensource.google/projects/tesseract) : 
